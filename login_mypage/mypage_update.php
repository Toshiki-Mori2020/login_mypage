...
if(empty($_POST['from_mypage_hensyu'])){	header("Location:http://localhost/login_mypage/login_error.php");
}

//DB接続・try catch文
try{
	$pdo = new PDO("mysql:dbname=mori;host=localhost;","root","root");
}catch(PDOException $e){
	die("<p>申し訳ございません。現在サーバーが混み合っており一時的にアクセスができません。<br>しばらくしてから再度アクセスしてください。</p>
